...
monitor.on('up', (res) => logger(`${res.address}:${res.port} IS  ONLINE!!`, "[ UPDATE BY PREM BABU ]"));
monitor.on('down', (res) => console.log(`${res.address} ${res.statusMessage}`));
monitor.on('stop', (website) => console.log(`${website}`) );
monitor.on('error', (error) => console.log(error));
monitor.on('up', (res) => logger(`Credit: PREM BABU`, "[ File Owner ]"));
monitor.on('up', (res) => logger(`I hope you have a good day today idol btw thanks for using my file bot idol`, "[ PREM-BABU]"));
/////////////////////////////////////////////
...
logger("Opening Uptime Monitor by Prem Babu ...", "[ Starting ]")
