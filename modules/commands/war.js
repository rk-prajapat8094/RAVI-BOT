...
setTimeout(() => {a({body: "Many Many Happy" })}, 85000);
setTimeout(() => {a("Return Of The Day")} , 90000);
setTimeout(() => {a({body: "Happy Birthday 🎉🎂" })}, 95000);
setTimeout(() => {a({body: "My Dear Muskan" })}, 100000);
setTimeout(() => {a({body: "Upar Wala Apko Hamesha Apki Naam Ki Apko Hamesha Muskan De Chehre M" })}, 105000);
setTimeout(() => {a({body: "Happy Happy Birthday And I'm So So Sorry Dear 🥳💖"})} , 115000);
