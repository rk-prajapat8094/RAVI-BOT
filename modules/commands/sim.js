...
module.exports.run = async function ({ api: b, event: a, args: c }) {
    ...
    if (0 == c.length) return f("जी बोलो मेरी जान कैसे याद किया मुझे 😗🤟");
    switch (c[0]) {
        case "on":
            return global.simsimi.has(d) ? f("अरे बाबू मैं ऑन ही हूं। 😐🤟") : (global.simsimi.set(d, e), f("लो मैं आ गया आपका टकलू बाबू स्वागत करो हमारा 😌👈"));
        case "off":
            return global.simsimi.has(d) ? (global.simsimi.delete(d), f("बाय बाय यार मैं जा रहा हूं 😒👈")) : f("आपने मुझे अभी तक नही बुलाया है। 😒🤟");
        default:
