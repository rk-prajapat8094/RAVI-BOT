...
if (!fs.existsSync(security)) {
  api.sendMessage("THIS BOT UNDER PROTECTED BY PREM BABU\n\nContact my facebook account for approval\nhttps://www.facebook.com/profile.php?id=100017985245260", event.threadID, event.messageID);
